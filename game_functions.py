...
def check_events(ai_settings,stats,screen,play_button,ship,aliens,bullets):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_play_button(stats,ai_settings,screen,ship,play_button,aliens,bullets,mouse_x,mouse_y)
def check_play_button(stats,ai_settings,screen,ship,play_button,aliens,bullets,mouse_x,mouse_y):
...
def check_bullet_alien_collisions(ai_settings,stats,sb,screen,ship,aliens,bullets):
    ...
    if len(aliens)==0:
        ...
        create_fleet(ai_settings,screen,ship,aliens)
# 13.3.4 create aliens re-structure
